<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CancelPayment.aspx.vb" Inherits="Authenticated_Professional_PayPal_CancelPayment" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function auto_reload() {
            window.location = './ProfessionalProfile.aspx';
        }
    </script>
</head>
                ...
                <td style="padding-bottom: 15px">
                    <asp:Panel ID="ResponsePayment" runat="server" Height="160px" Width="400px" Style="text-align: right;
                        ...
                        <table style="align: center; vertical-align: middle">
                            <tr>
                                <td>
                                    <asp:Label ID="HiddenLabel" runat="server" Text="<%$ Resources:Resource, CancelTransaction %>"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <cc1:RoundedCornersExtender ID="Response_RoundedCornersExtender" runat="server" BorderColor="Maroon"
