<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RearrangeWorkPhotos.aspx.vb"
                    ...
                    <td>
                        <table align="center">
                            <tr>
                                ...
                                <td>
                                    <asp:Panel ID="GlobalRearrangePanel" runat="server" Height="634px" Width="746px"
                                        Style="z-index: 101; position: relative; top: 25px; width: 699px; height: 634px">
                                        <asp:Panel ID="AlbumPanel" runat="server" Height="28px" Width="290px" BackColor="#cccccc"
                                            ...
                                            <asp:ObjectDataSource ID="AlbumObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                SelectMethod="GetProfessionalWorkPicture" TypeName="ProfessionalWorkShopPhotoDataSetTableAdapters.ProfessionalWorkAlbumTableAdapter">
                                                <SelectParameters>
                                        ...
                                        <asp:Panel ID="RearrangePanel" runat="server" Height="560px" Style="position: relative;
                                            background-color: #ffffff; z-index: 5;" Width="674px">
                                            <asp:UpdatePanel ID="RearrangeUpdatePanel" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    ...
                                                    <asp:ObjectDataSource ID="RearrangeObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                        SelectMethod="GetAllProfessionalWorkPhoto" TypeName="ProfessionalWorkShopPhotoDataSetTableAdapters.ReorderProfessionalWorkPhotoTableAdapter"
