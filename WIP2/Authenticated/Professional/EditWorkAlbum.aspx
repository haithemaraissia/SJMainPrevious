<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditWorkAlbum.aspx.vb" Inherits="_EditAlbum"
...
<body>
    ...
    <div id="wrapper" style="padding-top: 25px; padding-bottom: 15px">
                ...
                <td>
                    <table align="center">
                        <tr>
                            ...
                            <td>
                                <asp:Panel ID="GlobalAlbumPanel" Style="z-index: 101; top: 0px; width: 699px; position: relative;
                                    top: 0px; height: 615px; background-color: #ffffff;" runat="server">
                                        ...
                                        <asp:UpdatePanel ID="EditAlbumUpdatePanel" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="AlbumDropDownList" runat="server" AutoPostBack="True" Style="position: relative;
                                                    left: 3px; top: 1px;" DataSourceID="ProfessionalWorkAlbumObjectDataSource" DataTextField="AlbumCaption"
                                                ...
                                                <asp:ObjectDataSource ID="ProfessionalWorkAlbumObjectDataSource" runat="server" DeleteMethod="DELETEProfessionalWorkALBUM"
                                                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetProfessionalWorkPicture"
                                                    TypeName="ProfessionalWorkShopPhotoDataSetTableAdapters.ProfessionalWorkAlbumTableAdapter"
                                                    UpdateMethod="UpdateProfessionalWorkAlbum">
                                                    <DeleteParameters>
                                        ...
                                        <asp:UpdatePanel ID="PhotoUpdatePanel" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:ObjectDataSource ID="PhotoListObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                    SelectMethod="GetProfessionalAlbumWorkPhoto" TypeName="ProfessionalWorkShopPhotoDataSetTableAdapters.ProfessionalWorkPhotoTableAdapter">
                                                    <SelectParameters>
                                                        <asp:SessionParameter Name="ProID" SessionField="ProfessionalID" Type="Int32" />
                                ...
                                <asp:Panel ID="ModifyAlbumPanel" runat="server" BackColor="Silver" BorderColor="Maroon"
                                    BorderStyle="Solid" BorderWidth="3px" Height="120px" Style="display: none; left: 501px;
                                    position: absolute; top: 797px" Width="325px">
                            ...
                            <td>
                                <asp:Panel ID="ProfessionalProfileMenu" CssClass="BlueMenublock" runat="server" Height="70px"
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <asp:HyperLink ID="UploadCustomerPhotoHyperLink" runat="server" NavigateUrl="UploadProfessionalWorkPhoto.aspx"
    ...
    <asp:Panel ID="PanelEditPhoto" runat="server" Height="324px" Style="display: none;
        ...
        <asp:UpdatePanel ID="EditPhotoUpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <asp:ObjectDataSource ID="PhotoObjectDataSource" runat="server" DeleteMethod="DeleteProfessionalSpecificWorkPhoto"
                    SelectMethod="GetSpecificWorkPhoto" TypeName="ProfessionalWorkShopPhotoDataSetTableAdapters.ProfessionalWorkPhotoTableAdapter"
                    UpdateMethod="UpdateProfessionalWorkPhoto" OldValuesParameterFormatString="original_{0}">
                    <DeleteParameters>
                        <asp:Parameter Name="ProID" Type="Int32" />
