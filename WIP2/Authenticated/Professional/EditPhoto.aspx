            ...
            <asp:UpdatePanel ID="DelayModalUpdatePanel" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="LoadingPanel" runat="server" Height="45px" Style="display: none; left: 38px;
                        ...
                        <img src="../../Images/uploading.gif" style="left: 0px; position: relative; top: -9px" alt="loading" />
                    </asp:Panel>
                    <br />
                </ContentTemplate>
            </asp:UpdatePanel>
                                        ...
                                        <asp:UpdatePanel ID="PhotoUpdatePanel" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:ObjectDataSource ID="ProfessionalPhotoObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                    ...
                                                    DeleteMethod="DeleteProfessionalPhotoByID" UpdateMethod="UpdateProfessionalPhoto">
                                                    <DeleteParameters>
                                                ...
                                                <asp:DetailsView ID="PhotoDetailsView" runat="server" AutoGenerateRows="False" DataKeyNames="PhotoID"
                                                    DataSourceID="ProfessionalPhotoObjectDataSource" DefaultMode="Edit" Font-Size="8pt"
