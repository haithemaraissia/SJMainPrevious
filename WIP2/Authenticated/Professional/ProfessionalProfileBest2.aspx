<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProfessionalProfileBest2.aspx.vb"
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head id="Head1" runat="server"><title>Professional Profile</title><script language="javascript" type="text/javascript">
    ...
    </script><link href="../themes/opera/tabs.css" rel="stylesheet" type="text/css" /><link href="../themes/BlueMenublockStyleSheet.css" rel="stylesheet" type="text/css" /><style type="text/css">
        .modalBackground
        {
   ...
   <cc1:ToolkitScriptManager ID="ScriptManager1" runat="server"></cc1:ToolkitScriptManager>
    <cc1:TabContainer ID="ProfileTabContainer" CssClass="opera" runat="server" ActiveTabIndex="13"
                            ...
                            <td style="width: 160px; background-color: #ffffff; height: 452px;" rowspan="2">
                                ...
                                <asp:Panel ID="ProfessionalProfileMenu" CssClass="BlueMenublock" runat="server" Height="64px"
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <asp:HyperLink ID="UploadCustomerPhotoHyperLink" runat="server" NavigateUrl="UploadProfessionalPhoto.aspx"
                        ...
                        <asp:UpdatePanel ID="ActiveTransactionUpdatePanel" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2900" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                    SelectCommand="SELECT TransactionID, ProjectID, ProjectAmount, AmountCharged, DateCharged, StatusID, (SELECT CurrencyValue FROM Currency WHERE (CurrencyID = CustomerTransaction.CurrencyID)) AS Currency, PaymentDue, PhaseStatus FROM CustomerTransaction WHERE (ProID = @ProID)">
                                    <SelectParameters>
                        ...
                        <asp:UpdatePanel ID="TransactionHistoryUpdatePanel" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSourcecustomtComplete" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                    DeleteCommand="DELETE FROM CustomerTransactionHistory WHERE (TransactionID = @TransactionID) AND (ProID = @ProID)"
                                    SelectCommand="SELECT TransactionID, ProjectID, DateCharged, PhaseID, (SELECT CurrencyValue FROM Currency WHERE (CurrencyID = CustomerTransactionHistory.CurrencyID)) AS Currency, PaymentDue, PayerUserName, PayeeUserName, (SELECT Description FROM TransactionStatus WHERE (TransactionStatusID = CustomerTransactionHistory.TransactionStatusID)) AS Status, (SELECT PaymentMethodValue FROM PaymentMethod WHERE (PaymentMethodID = CustomerTransactionHistory.PaymentMethod)) AS PaymentMethod FROM CustomerTransactionHistory WHERE (ProID = @ProID)">
                                    <SelectParameters>
                                        <asp:SessionParameter Name="ProID" SessionField="ProfessionalID" />
                                    </SelectParameters>
                                    <DeleteParameters>
...
<ContentTemplate>
                    <asp:Panel ID="GlobalContractPanel" runat="server" BackColor="White" Height="300px"
                        ...
                        <asp:GridView ID="GlobalContractGridView" runat="server" AutoGenerateColumns="False"
                            DataSourceID="CustomerContractSqlDataSource" Height="90%" Style="position: relative"
                    ...
                    <asp:SqlDataSource ID="CustomerContractSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                        SelectCommand="SELECT CustomerContract.ContractID, CustomerContract.ProjectID, CustomerContract.ContractDate, CustomerContract.BidderUsername, CustomerContract.PosterUsername, CustomerContract.HighestBid, (SELECT CurrencyValue FROM Currency WHERE (CurrencyID = CustomerContract.CurrencyID)) AS Currency FROM CustomerContract INNER JOIN Currency AS Currency_1 ON CustomerContract.CurrencyID = Currency_1.CurrencyID WHERE (CustomerContract.ProID = @ProID)">
                        <SelectParameters>
                            <asp:SessionParameter Name="ProID" SessionField="ProfessionalID" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                        ...
                        <asp:UpdatePanel ID="DetailContractUpdatePanel" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2cdfhfd" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                    SelectCommand="SELECT CustomerContract.ProjectID, ProjectRequirements.CategoryName, Projects.HighestBidderID, Projects.NumberofBids, ProjectRequirements.StartDate, ProjectRequirements.EndDate, ProjectRequirements.Description, ProjectRequirements.SpecialNotes FROM Projects INNER JOIN ProjectRequirements ON Projects.ProjectID = ProjectRequirements.ProjectID INNER JOIN CustomerContract ON CustomerContract.ProjectID = Projects.ProjectID WHERE (CustomerContract.ContractID = @ContractID)">
                                    <SelectParameters>
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="ActiveBidsPanel" runat="server" BackColor="White" Height="200px" Style="left: 0px;
                                ...
                                <asp:GridView ID="ActiveBidsGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    CellPadding="4" DataKeyNames="BidID" DataSourceID="CustomerBidDataSource" ForeColor="#333333"
                            ...
                            <asp:SqlDataSource ID="SqlDataSource299" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                SelectCommand="SELECT Bids.ProjectID, (SELECT ProjectTitle FROM ProjectRequirements WHERE (ProjectID = Bids.ProjectID)) AS ProjectTitle, Bids.AmountOffered, (SELECT CurrencyValue FROM Currency WHERE (CurrencyID = Bids.CurrencyID)) AS Expr1, Bids.BidDate, CustomerWinBid.BidID FROM Bids INNER JOIN CustomerWinBid ON Bids.BidID = CustomerWinBid.BidID WHERE (CustomerWinBid.ProID = @ProID)"
                                DeleteCommand="DELETE FROM CustomerWinBid WHERE (BidID = @BidID)">
                                <SelectParameters>
                                    <asp:SessionParameter Name="ProID" SessionField="ProfessionalID" />
                                </SelectParameters>
                                <DeleteParameters>
             ...
             <ContentTemplate>
                 <table style="z-index: 101; left: 0px; width: 100%; position: static; height: 79%;
                     ...
                     <tr>
                         ...
                         <td style="width: 100px; height: 452px;" rowspan="2" id="Td1">
        ...
        <asp:UpdatePanel ID="DetailTransactionUpdatePanel" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource46846" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                    SelectCommand="SELECT [PhaseStatus] FROM [CustomerTransaction] WHERE ([TransactionID] = @TransactionID)">
                    <SelectParameters>
...
<%--    <div id="WelcomeCustomerHeader" style="z-index: 111; left: 745px; width: 230px; position: absolute;
...
<%--    <div id="LoginDiv">
        <asp:LoginStatus ID="ProfessionalLoginStatus" runat="server" 
            LogoutPageUrl="~/NotAuthenticated/Index.aspx"
            Style="left: 850px; position: absolute; top: 77px; " />
       ...
       <div id="LoginDiv" style="z-index: 111; left:745px; width: 230px; position: absolute;
        top: 0px; height: 100px; bottom: 357px; text-align:center ">
        <asp:LoginView ID="ProfessionalLoginView" runat="server">
            <LoggedInTemplate>
                <asp:Label ID="WelcomeLabel" runat="server" Text="<%$ Resources:Resource, WelcomeBackLabel %>"></asp:Label>
