<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProfessionalProfileBest0.aspx.vb"
...
<body>
    ...
    <form id="form1" runat="server">
        <div style="overflow: visible">
            ...
            <cc1:ToolkitScriptManager ID="ScriptManager1" runat="server"></cc1:ToolkitScriptManager>
             <asp:SqlDataSource ID="ProfessionalDetailProfileSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                    OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT DISTINCT ProID, FirstName, LastName, UserName, Address, CountryID, CountryName, RegionID, RegionName, CityID, CityName, Zipcode, HomePhoneNumber, MobilePhoneNumber, Age, Gender, EmailAddress FROM ProfessionalGeneral WHERE (ProID = @ProID)">
                    <SelectParameters>
            ...
            <div style="z-index: 110; left: 39px; width: 411px; position: absolute; top: 102px;
                ...
                <cc1:TabContainer ID="ProfileTabContainer" runat="server" ActiveTabIndex="10" Height="541px"
                    Width="910px" EnableTheming="True" BorderWidth="0px" CssClass="opera" 
                    BackColor="White" style="vertical-align: top">
                                            ...
                                            <ContentTemplate>
                                                <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" DataKeyNames="ProID"
                                                    ...
                                                    <Fields>
                                                        ...
                                                        <asp:BoundField DataField="RegionName" HeaderText="State/Region" SortExpression="RegionName" />
                                                        <asp:BoundField DataField="CityName" HeaderText="City" SortExpression="CityName" />
                                                        <asp:BoundField DataField="Zipcode" HeaderText="Zipcode" SortExpression="Zipcode" />
                                                        <asp:BoundField DataField="HomePhoneNumber" HeaderText="Home Phone Number" SortExpression="HomePhoneNumber" />
                                                        <asp:BoundField DataField="MobilePhoneNumber" HeaderText="Mobile Phone Number" SortExpression="MobilePhoneNumber" />
                                                    ...
                                                    <FieldHeaderStyle BackColor="#E0E0E0" Width="50%" />
                                                </asp:DetailsView>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
     ...
     <table style="z-index: 101; left: 0px; width: 100%; position: static; height: 79%; top: 75px;"
                    ...
                    <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                        <ContentTemplate>
                        <asp:Panel ID="PaneladdProject" runat="server" CssClass="BlueMenublock" Height="16px" Style="z-index: 99;
                                            left: 746px; position: relative; top:101px" Width="130px" Font-Size="10pt">
                                <ul>
                                    <li>
                                        <asp:LinkButton ID="LinkButton15" runat="server" Font-Bold="True" Font-Size="Small"
                                            Width="76px">Add New Project</asp:LinkButton>
                                    </li>
                                </ul>
                            </asp:Panel>
                            <table style="left: 0px; width: 100%; position: relative; top: -18px; height: 100%" cellpadding="1" cellspacing="2">
                                <tr>
                                    <td colspan="3" style="vertical-align: top; height: 50%;">
                                        <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                                    CellPadding="4" DataKeyNames="ProjectID" DataSourceID="ProjectSqlDataSource"
                                                    ForeColor="#333333" GridLines="None" Height="250px" Style="position: relative"
                                                    Width="713px" OnRowCommand="GridView2_RowCommand">
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton5" runat="server" CausesValidation="False" CommandName="select"
                                                                    Font-Bold="True" ForeColor="#000040" Style="position: relative">View</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton7" runat="server" Font-Bold="True" ForeColor="#400000"
                                                                    Style="position: relative" CausesValidation="False" CommandName="delete">Delete</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                    ...
                                                    <EmptyDataTemplate>
                                                        <asp:Label ID="Label13" runat="server" Style="position: relative" Text="No Project"></asp:Label>
                                                    </EmptyDataTemplate>
                                                </asp:GridView>
                                                <asp:SqlDataSource ID="ProjectSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                                    SelectCommand="SELECT ProjectRequirements.ProjectID, ProjectRequirements.ProjectTitle, ProjectRequirements.StartDate, ProjectRequirements.EndDate, ProjectRequirements.AmountOffered FROM Projects INNER JOIN ProjectRequirements ON Projects.ProjectID = ProjectRequirements.ProjectID WHERE (Projects.PosterID = @ProID)" DeleteCommand="DeleteProject" DeleteCommandType="StoredProcedure">
                                                    <SelectParameters>
                                                        <asp:SessionParameter Name="ProID" SessionField="ProID" />
                                                    </SelectParameters>
                                                    <DeleteParameters>
                                ...
                                <tr>
                                    <td style="width: 37%; height: 91%; vertical-align: middle; background-color: slategray;">
                                        <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:FormView ID="FormView3" runat="server" DataKeyNames="PhotoID" DataSourceID="DetailProjectSqlDataSource"
                                                    Height="166px" Style="position: relative; left: 17px; top: 13px;" Width="284px">
                                                    <EditItemTemplate>
                                                        CategoryName:
                                                        ...
                                                        ExperienceID:
                                                        <asp:TextBox ID="ExperienceIDTextBox" runat="server" Text='<%# Bind("ExperienceID") %>'>
                                                        </asp:TextBox><br />
                                                        CrewNumberID:
                                                        <asp:TextBox ID="CrewNumberIDTextBox" runat="server" Text='<%# Bind("CrewNumberID") %>'>
                                                        </asp:TextBox><br />
                                                        LicensedID:
                                                        <asp:TextBox ID="LicensedIDTextBox" runat="server" Text='<%# Bind("LicensedID") %>'>
                                                        </asp:TextBox><br />
                                                        InsuredID:
                                                        <asp:TextBox ID="InsuredIDTextBox" runat="server" Text='<%# Bind("InsuredID") %>'>
                                                        </asp:TextBox><br />
                                                        RelocationID:
                                                        <asp:TextBox ID="RelocationIDTextBox" runat="server" Text='<%# Bind("RelocationID") %>'>
                                                        </asp:TextBox><br />
                                                        Description:
                                                        <asp:TextBox ID="DescriptionTextBox" runat="server" Text='<%# Bind("Description") %>'>
                                                        </asp:TextBox><br />
                                                        SpecialNotes:
                                                        <asp:TextBox ID="SpecialNotesTextBox" runat="server" Text='<%# Bind("SpecialNotes") %>'>
                                                        </asp:TextBox><br />
                                                        PhotoID:
                                                        <asp:Label ID="PhotoIDLabel1" runat="server" Text='<%# Eval("PhotoID") %>'></asp:Label><br />
                                                        PhotoPath:
                                                    ...
                                                    <ItemTemplate>
                                                        <table style="width: 100%; position: relative; height: 100%">
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label14" runat="server" Style="position: relative" Text="Label"></asp:Label></td>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="CategoryNameLabel" runat="server" Style="position: relative" Text='<%# Bind("CategoryName") %>'></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label15" runat="server" Style="position: relative" Text="Label"></asp:Label></td>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="JobTitleLabel" runat="server" Style="position: relative" Text='<%# Bind("JobTitle") %>'></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label16" runat="server" Style="position: relative" Text="Label"></asp:Label></td>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="ExperienceIDLabel" runat="server" Style="position: relative" Text='<%# Bind("ExperienceID") %>'></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label17" runat="server" Style="position: relative" Text="Label"></asp:Label></td>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="CrewNumberIDLabel" runat="server" Style="position: relative" Text='<%# Bind("CrewNumberID") %>'></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label18" runat="server" Style="position: relative" Text="Label"></asp:Label></td>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="LicensedIDLabel" runat="server" Style="position: relative" Text='<%# Bind("LicensedID") %>'></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label19" runat="server" Style="position: relative" Text="Label"></asp:Label></td>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="InsuredIDLabel" runat="server" Style="position: relative" Text='<%# Bind("InsuredID") %>'></asp:Label></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label20" runat="server" Style="position: relative" Text="Label"></asp:Label></td>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="RelocationIDLabel" runat="server" Style="position: relative" Text='<%# Bind("RelocationID") %>'></asp:Label></td>
                                                            </tr>
                                                        </table>
                                                        <br />
                                                        <asp:LinkButton ID="LinkButton6" runat="server" CausesValidation="False" Font-Bold="True"
                                                            OnClick="LinkButton6_Click" Style="left: 223px; position: relative; top: -9px"
                                                            Width="59px">Edit</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:FormView>
                                                <cc1:RoundedCornersExtender ID="RoundedCornersExtender4" runat="server" BorderColor="White"
                                                    Color="White" Radius="8" TargetControlID="FormView3">
                                                </cc1:RoundedCornersExtender>
                                            </ContentTemplate>
                                            <Triggers>
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:SqlDataSource ID="DetailProjectSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                            SelectCommand="SELECT ProjectRequirements.CategoryName, ProjectRequirements.JobTitle, ProjectRequirements.ExperienceID, ProjectRequirements.CrewNumberID, ProjectRequirements.LicensedID, ProjectRequirements.InsuredID, ProjectRequirements.RelocationID, ProjectRequirements.Description, ProjectRequirements.SpecialNotes, ProjectPhoto.PhotoID, ProjectPhoto.PhotoPath FROM ProjectRequirements INNER JOIN ProjectPhoto ON ProjectRequirements.ProjectID = ProjectPhoto.ProjectID WHERE (ProjectRequirements.ProjectID = @ProjectID)">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="GridView2" Name="ProjectID" PropertyName="SelectedValue" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                                        &nbsp;
                                    </td>
                                    
                                        <td style="width: 30%; height: 91%; vertical-align: middle; background-color: slategray;">
                                        <asp:UpdatePanel ID="UpdatePanel14" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:FormView ID="FormView4" runat="server" DataKeyNames="PhotoID" DataSourceID="DetailProjectSqlDataSource"
                                                    Height="166px" Style="position: relative; left: 0px; top: -8px;" Width="290px">
                                                    <EditItemTemplate>
                                                        CategoryName:
                                                        <asp:TextBox ID="CategoryNameTextBox" runat="server" Text='<%# Bind("CategoryName") %>'>
                                                        </asp:TextBox><br />
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:Image ID="Image3" runat="server" Height="182px" ImageUrl='<%# Bind("PhotoPath", "{0}") %>'
                                                            Style="position: relative" Width="229px" /><br />
                                                    </ItemTemplate>
                                                </asp:FormView>
                                            </ContentTemplate>
                                            <Triggers>
                                        ...
                                        &nbsp;&nbsp;
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                            SelectCommand="SELECT ProjectRequirements.CategoryName, ProjectRequirements.JobTitle, ProjectRequirements.ExperienceID, ProjectRequirements.CrewNumberID, ProjectRequirements.LicensedID, ProjectRequirements.InsuredID, ProjectRequirements.RelocationID, ProjectRequirements.Description, ProjectRequirements.SpecialNotes, ProjectPhoto.PhotoID, ProjectPhoto.PhotoPath FROM ProjectRequirements INNER JOIN ProjectPhoto ON ProjectRequirements.ProjectID = ProjectPhoto.ProjectID WHERE (ProjectRequirements.ProjectID = @ProjectID)">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="GridView2" Name="ProjectID" PropertyName="SelectedValue" />
                                            </SelectParameters>
                                    ...
                                    <td style="width: 30%; height: 91%; vertical-align: middle; background-color: slategray;">
                                        <asp:UpdatePanel ID="UpdatePanel13" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:DetailsView ID="DetailsView4" runat="server" AutoGenerateRows="False" DataSourceID="ProjectExtraSqlDataSource"
                                                    Height="101px" Style="position: relative; left: 0px; top: -40px;" Width="149px">
                                                    <Fields>
                                        ...
                                        <asp:SqlDataSource ID="ProjectExtraSqlDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SideJobConnectionString %>"
                                            SelectCommand="SELECT Status, HighestBid, HighestBidderID, HighestBidUsername, NumberofBids, Posted FROM Projects WHERE (ProjectID = @ProjectID)">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="GridView2" Name="ProjectID" PropertyName="SelectedValue" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
  ...
  <asp:ListItem Value="1"></asp:ListItem>
                ...
                <asp:Panel ID="ChangePasswordPanel" runat="server" Style="z-index: 112; left: 203px;
                    position: absolute; top: 1008px; display: none; background-color: silver;" Width="360px"
