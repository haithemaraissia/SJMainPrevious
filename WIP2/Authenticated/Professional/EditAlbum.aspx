                        ...
                        <tr>
                                        ...
                                        <asp:UpdatePanel ID="EditAlbumUpdatePanel" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <asp:DropDownList ID="AlbumDropDownList" runat="server" AutoPostBack="True" Style="position: relative;
                                                    left: 3px; top: 1px;" DataSourceID="ProfessionalAlbumObjectDataSource" DataTextField="AlbumCaption"
                                                ...
                                                <asp:ObjectDataSource ID="ProfessionalAlbumObjectDataSource" runat="server" DeleteMethod="DeleteProfessionalAlbum"
                                                    OldValuesParameterFormatString="original_{0}" SelectMethod="GetProfessionalPicture"
                                                    TypeName="ProfessionalPhotoDataSetTableAdapters.ProfessionalAlbumTableAdapter"
                                                    UpdateMethod="UpdateProfessionalAlbum">
                                                    <DeleteParameters>
                                        ...
                                        <asp:UpdatePanel ID="PhotoUpdatePanel" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <asp:ObjectDataSource ID="PhotoListObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                    SelectMethod="GetProfessionalAlbumPhoto" TypeName="ProfessionalPhotoDataSetTableAdapters.ProfessionalPhotoTableAdapter">
                                                    <SelectParameters>
                                                        <asp:SessionParameter Name="ProID" SessionField="ProfessionalID" Type="Int32" />
                            ...
                            <td>
                                <asp:Panel ID="ProfessionalWorkShopProfileMenu" CssClass="BlueMenublock" runat="server"
                                    Height="70px" Style="z-index: 0; left: 20px; position: relative; top: 0px; height: 120px;
    ...
    <asp:Panel ID="PanelEditPhoto" runat="server" Height="324px" Style="display: none;
        ...
        <asp:UpdatePanel ID="EditPhotoUpdatePanel" runat="server">
            <ContentTemplate>
                ...
                <asp:ObjectDataSource ID="PhotoObjectDataSource" runat="server" DeleteMethod="DeleteProfessionalSpecificPhoto"
                    SelectMethod="GetSpecificPhoto" TypeName="ProfessionalPhotoDataSetTableAdapters.ProfessionalPhotoTableAdapter"
                    UpdateMethod="UpdateProfessionalPhoto" OldValuesParameterFormatString="original_{0}">
                    <DeleteParameters>
                        <asp:Parameter Name="ProID" Type="Int32" />
