<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UploadProfessionalPhoto.aspx.vb"
                  ...
                  <img  alt="" src="../../Images/uploading.gif" />
                                        ...
                                        <asp:Panel ID="PicturePanel" runat="server" Width="311px" Height="331px" Style="z-index: 1;
                                            ...
                                            <asp:UpdatePanel ID="PictureUpdatePanel" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:ListView ID="ProfessionalListView" runat="server" DataKeyNames="PhotoID" DataSourceID="ProfessionalPhotoDataSource"
                                                        Style="z-index: 2">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:ObjectDataSource ID="ProfessionalPhotoDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                        SelectMethod="GetData" TypeName="ProfessionalPhotoDataSetTableAdapters.SELECTALLProfessionalPhotoTableAdapter">
                                                        <SelectParameters>
