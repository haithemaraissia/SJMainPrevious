...
Partial Class _EditAlbum
    ...
    Protected Sub SaveAlbum_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If AddNewAlbumCustomValidator.IsValid = True Then
            If NewAlbumRequiredFieldValidator.IsValid = True Then
                ProfessionalWorkAlbumObjectDataSource.UpdateParameters(0).DefaultValue = AlbumDropDownList.SelectedValue.ToString
                ProfessionalWorkAlbumObjectDataSource.UpdateParameters(1).DefaultValue = Session("ProfessionalID").ToString
                ProfessionalWorkAlbumObjectDataSource.UpdateParameters(2).DefaultValue = AddAlbumTextbox.Text
                ProfessionalWorkAlbumObjectDataSource.Update()
    ...
    Protected Sub DeleteAlbum_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ProfessionalWorkAlbumObjectDataSource.DeleteParameters("ProID").DefaultValue = Session("ProfessionalID").ToString
        ProfessionalWorkAlbumObjectDataSource.DeleteParameters("AlbumID").DefaultValue = AlbumDropDownList.SelectedValue.ToString
        ProfessionalWorkAlbumObjectDataSource.Delete()
