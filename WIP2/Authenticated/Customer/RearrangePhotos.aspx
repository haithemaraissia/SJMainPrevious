                    ...
                    <td>
                        <table align="center">
                            <tr>
                                ...
                                <td>
                                    <asp:Panel ID="GlobalRearrangePanel" runat="server" Height="615px" Width="746px"
                                        Style="z-index: 101; position: relative; width: 699px; height: 634px">
                                        <asp:Panel ID="AlbumPanel" runat="server" Height="28px" Width="290px" BackColor="#cccccc"
                                            Style="position: relative; z-index: 104; left: 6px; top: 25px">
                                            ...
                                            <asp:ObjectDataSource ID="AlbumObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                SelectMethod="GetCustomerPicture" TypeName="CustomerPhotoDataSetTableAdapters.CustomerAlbumTableAdapter">
                                                <SelectParameters>
                                        ...
                                        <asp:Panel ID="RearrangePanel" runat="server" Style="position: relative; background-color: #ffffff;
                                            z-index: 5; top: -24px; left: 0px; height: 628px;" Width="699px">
                                            <asp:UpdatePanel ID="RearrangeUpdatePanel" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:DataList ID="RearrangeDataList" runat="server" DataKeyField="PhotoID" DataSourceID="RearrangeObjectDataSource"
                                                        ...
                                                        <ItemTemplate>
                                                            <div ID="ItemTemplateDiv" onmouseout="this.style.background='white';" 
                                                                onmouseover="this.style.background='#BFC8D3';" 
                                                                style="height: 120px; width: 165px; left: 10px; top: 10px">
                                                                <asp:TextBox ID="RankTextBox" runat="server" BackColor="#E0E0E0" 
                                                                    OnTextChanged="RankTextBox_TextChanged" ReadOnly="True" 
                                                                    Style="left: 5px; position: relative; top: -65px" 
                                                                    Text='<%# Eval("PhotoRank", "{0}") %>' Width="15px"></asp:TextBox>
                                                                <asp:ImageButton ID="PhotoImage" runat="server" Height="90px" 
                                                                ...
                                                                <asp:LinkButton ID="EditLinkButton" runat="server" CausesValidation="false" 
                                                                    CommandName="select" Font-Size="10pt" Font-Strikeout="False" 
                                                                    Font-Underline="False" ForeColor="Red" 
                                                                    onmouseout="this.style.textDecoration = 'none';" 
                                                                    onmouseover="this.style.textDecoration = 'underline';" Style="left: 12px; position: relative;
                                                                    top: -65px" Text="<%$ Resources:Resource, Edit %>"></asp:LinkButton>
                                                                <br />
                                                                ...
                                                                <br />
                                                                <asp:RequiredFieldValidator ID="RankRequiredFieldValidator" runat="server" 
                                                                    ControlToValidate="RankTextBox" Display="Dynamic" 
                                                                    ErrorMessage="<%$ Resources:Resource, RankRequiredFieldValidator %>" 
                                                                    Font-Size="10pt" Style="left: 0px; position: relative; top: -8px"></asp:RequiredFieldValidator>
                                                                <asp:RangeValidator ID="RankRangeValidator" runat="server" 
                                                                    ControlToValidate="RankTextBox" Display="Dynamic" 
                                                                    ErrorMessage="<%$ Resources:Resource, RankRangeValidator %>" Font-Size="10pt" 
                                                                    MaximumValue="1000" MinimumValue="0" Style="left: 0px; position: relative;
                                                    ...
                                                    <asp:ObjectDataSource ID="RearrangeObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
                                                        SelectMethod="GetAllCustomerPhoto" TypeName="CustomerPhotoDataSetTableAdapters.ReorderCustomerPhotoTableAdapter"
                                                ...
                                                <Triggers>
                                                    ...
                                                    <asp:AsyncPostBackTrigger ControlID="RearrangeDataList" 
                                        ...
                                        <asp:Panel ID="ActionsPanel" runat="server" Style="text-align: center">
                                            <asp:LinkButton ID="CancelButton" runat="server" Font-Bold="True" ForeColor="DarkRed"
                                                ...
                                                BorderWidth="1px" Style="left: 550px; position: absolute; top: 34px; z-index: 103;"
                                            ...
                                            <asp:LinkButton ID="SaveButton" runat="server" Height="20px" Font-Bold="True" ForeColor="DarkRed"
                                                ...
                                                top: 34px; z-index: 104;" BorderColor="Maroon" BorderStyle="Outset" BorderWidth="1px"
