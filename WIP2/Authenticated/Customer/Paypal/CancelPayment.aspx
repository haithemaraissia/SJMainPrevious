<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CancelPayment.aspx.vb" Inherits="Authenticated_Customer_Paypal_CancelPayment" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function auto_reload() {
            window.location = './CustomerProfile.aspx';
        }
    </script>
</head>
