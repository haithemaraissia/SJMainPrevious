<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LockedUser.aspx.vb" Inherits="NotAuthonitizated_LockedUser" %>
...
<body>
    ...
    <div id="wrapper" style="padding: 25px">
        <table align="center" id="TemplateGlobalTable">
            <tr>
                <td>
                   _Please contac t csutoemr service because your account has been locked
                </td>
            </tr>
        </table>
    </div>
